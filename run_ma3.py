...
#是否开启“随机打字“模式
_ENABLE_TYPO_MODE = flags.DEFINE_boolean(
    'enable_typo_mode',
    False,
    'Whether to enable random typo mode for all input_text actions.'
)
...
def _get_agent(
  ...
  agent = None
  typo_mode = _ENABLE_TYPO_MODE.value  # 记录是否开启随机打字模式
  ...
  # Mobile Agent v3.
    ...
    agent = mobile_agent_v3.MobileAgentV3_M3A(env, infer_ma3.GUIOwlWrapper(_API_KEY.value, _BASE_URL.value, _MODEL.value), output_path=(_TRAJ_OUTPUT_PATH.value),enable_typo_mode=typo_mode)
